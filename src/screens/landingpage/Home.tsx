...
const Home = () => {
  const [userName, setUserName] = React.useState('Rohan');
  const [greeting, setGreeting] = React.useState('Good Afternoon');
  const navigation = useNavigation();
  const fooditems = [
    {name: 'Breakfast', icon: <BreakfastIcon />},
    {name: 'Pastries', icon: <CakesIcon />},
    {name: 'Sweet', icon: <CandyIcon />},
    {name: 'Dessert', icon: <DessertsIcon />},
          ...
          {fooditems.map((item, index) => (
            <View
              ...
              <TouchableOpacity
                ...
                <View style={styles.fooditem}>{item.icon}</View>
              </TouchableOpacity>
